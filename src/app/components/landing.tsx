...
import { ArrowRight, ArrowUpRight, Palette, Globe, Share2, Video, Code, Camera, Megaphone, Zap } from 'lucide-react';
...
export default function ResponsiveCreativeStudio() {
  ...
  const services = [
    { id: 'branding', icon: <Palette size={32} />, title: 'BRANDING', color: 'from-pink-500 to-rose-500' },
    { id: 'website', icon: <Globe size={32} />, title: 'WEBSITE', color: 'from-blue-500 to-cyan-500' },
    { id: 'social', icon: <Share2 size={32} />, title: 'SOCIAL', color: 'from-purple-500 to-violet-500' },
    { id: 'production', icon: <Video size={32} />, title: 'PRODUCTION', color: 'from-green-500 to-emerald-500' }
  ];

  const desktopServices = [
    { id: 'branding', icon: <Palette size={32} />, title: 'Branding', color: 'from-pink-500 to-rose-500' },
    { id: 'website', icon: <Globe size={32} />, title: 'Website', color: 'from-blue-500 to-cyan-500' },
    { id: 'social', icon: <Share2 size={32} />, title: 'Social Media', color: 'from-purple-500 to-violet-500' },
    { id: 'production', icon: <Video size={32} />, title: 'Production', color: 'from-green-500 to-emerald-500' },
    { id: 'development', icon: <Code size={32} />, title: 'Development', color: 'from-orange-500 to-amber-500' },
    { id: 'photography', icon: <Camera size={32} />, title: 'Photography', color: 'from-teal-500 to-cyan-500' },
    { id: 'marketing', icon: <Megaphone size={32} />, title: 'Marketing', color: 'from-indigo-500 to-purple-500' },
    { id: 'consulting', icon: <Zap size={32} />, title: 'Consulting', color: 'from-yellow-500 to-orange-500' }
  ];
      ...
      <div className="hidden md:flex relative z-10 min-h-screen flex-col items-center justify-center px-6 py-12">
        ...
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <p className="text-xl md:text-2xl text-gray-400 max-w-2xl mx-auto leading-relaxed">
            Choose your path and let us bring your vision to life with our expert services.
          </p>
        </div>

        {/* Desktop Services Grid */}
        <div className={`grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto transform transition-all duration-1000 delay-500 ${
          isLoaded ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
        }`}>
