...
const TeslaMasonryPortfolio = () => {
  ...
  const portfolioItems = [
    ...
    {
      id: 5,
      image: "https://imgs.search.brave.com/ijmxs-aPb9MjFvw5N23R6J_5N-wzF_cNBRAxJ9rPC8k/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLmlu/c2lkZXIuY29tLzY0/ZmEwMmE1NTZmNTE5/MDAxOWZkMWUxOD93/aWR0aD03MDA",
      size: "wide",
      title: "Cybertruck",
    ...
    {
      id: 8,
      image: "https://images.unsplash.com/photo-1593941707874-ef25b8b4a92b?w=400&h=500&fit=crop",
      size: "small",
      title: "Supercharger",
    ...
    {
      id: 10,
      image: "https://imgs.search.brave.com/KJfWKdX67KFg_ogSwYnu62EBlJqKyPjd9xT8oEmjYEM/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly90aHVt/YnMuZHJlYW1zdGlt/ZS5jb20vYi9hbHRl/cm5hdGl2ZS1zb2xh/ci1lbmVyZ3ktc29s/YXItcG93ZXItcGxh/bnQtMTUxMTA5MzQu/anBn",
      size: "small",
      title: "Solar Roof",
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-min">
          {portfolioItems.map((item, index) => (
            <div
              key={item.id}
              className={`group relative overflow-hidden rounded-xl cursor-pointer ${getSizeClasses(item.size)}`}
            ...
            >
              ...
              <img
                ...
                className={`w-full h-full object-cover transition-all duration-700 ${
                  hoveredCard === item.id ? 'scale-110 brightness-110' : 'scale-100 brightness-75'
                }`}
              />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-4 text-white">
                <h3 className={`font-bold text-lg mb-2 transition-all duration-300 ${
                  hoveredCard === item.id ? 'text-red-400 transform translate-y-0' : 'transform translate-y-2'
                }`}>
                  {item.title}
                </h3>
                <p className={`text-sm text-gray-300 transition-all duration-500 ${
                  hoveredCard === item.id ? 'opacity-100 transform translate-y-0' : 'opacity-0 transform translate-y-4'
                }`}>
                  {item.description}
                </p>
              </div>
              ...
              <div 
                className={`absolute inset-0 border-2 border-transparent transition-all duration-500 rounded-xl ${
                  hoveredCard === item.id ? 'border-red-500/50 shadow-[0_0_30px_rgba(239,68,68,0.3)]' : ''
                }`}
              ></div>
              ...
              <div 
                className={`absolute top-4 right-4 w-3 h-3 rounded-full transition-all duration-500 ${
                  hoveredCard === item.id ? 'bg-red-500 shadow-[0_0_20px_rgba(239,68,68,0.8)]' : 'bg-white/30'
                }`}
              ></div>
              ...
              <div 
                ...
                style={{
                  transform: hoveredCard === item.id ? 'translateX(100%) skewX(-20deg)' : 'translateX(-100%) skewX(-20deg)',
                }}
              ></div>
            </div>
          ))}
          ...
          >
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-2xl">
              <img
                ...
                style={{
                  animation: 'imageZoomIn 0.5s cubic-bezier(0.23, 1, 0.320, 1) 0.1s both'
                }}
              />
              ...
              <div 
                ...
                style={{
                  animation: 'slideUp 0.6s cubic-bezier(0.23, 1, 0.320, 1) 0.2s both'
                }}
              >
      ...
      <div className="fixed top-1/3 right-10 w-2 h-16 bg-gradient-to-b from-blue-500 to-transparent opacity-30 animate-pulse" style={{animationDelay: '1s'}}></div>
      <section>
        <Footer/>
      </section>
      <style jsx>{`
